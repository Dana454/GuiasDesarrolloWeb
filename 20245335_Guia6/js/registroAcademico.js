document.addEventListener("DOMContentLoaded", function () {
  console.log('registroAcademico: DOMContentLoaded');
  ...
  if (btnAddEstudiante) {
    ...
    console.warn("Botón 'idBtnAgregarEstudiante' no encontrado en el DOM.");
  }

  if (btnViewEstudiantes) {
    btnViewEstudiantes.addEventListener("click", viewEstudiantes);
  } else {
    console.warn("Botón 'idBtnMostrarEstudiantes' no encontrado en el DOM.");
  }
...
//Creando funciones
  function addEstudiantes() {
    console.log('addEstudiantes llamado');
    const inputCarnet = document.querySelector("#inputCarnet").value.trim().toUpperCase();
    const inputNombre = document.querySelector("#inputNombres").value.trim().toUpperCase();
